                        ...
                        <AlertDialogDescription>
                            ...
                            {(categoryToDelete?.chat_count || 0) > 0 && (
                                <div className="mt-2 text-orange-600">
                                    Warning: This category has {categoryToDelete?.chat_count}{" "}
                                    chat(s) assigned to it.
                                </div>
                            )}
                            {(categoryToDelete?.character_count || 0) > 0 && (
                                <div className="mt-2 text-orange-600">
                                    Warning: This category has {categoryToDelete?.character_count}{" "}
                                    character(s) assigned to it.
                                </div>
                            )}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
