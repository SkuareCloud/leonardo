...
import { addEdge, Edge, Node, NodeTypes, ReactFlow, useEdgesState, useNodesState } from "@xyflow/react"
...
export default function VerticalTree({ tree, nodeTypes, className, onNodeClick }: VerticalTreeProps) {
