...
export function MassMessageMissionBuilder({
  categories,
}: {
  ...
  useEffect(() => {
    ...
    payload.contacts_per_character = typeof contactsPerCharacter === "string" ? Number(contactsPerCharacter) || 100 : contactsPerCharacter
            ...
            <div className="grid grid-cols-2 gap-4">
              <InputWithLabel
                ...
                onBlur={e => {
                  ...
                  if (e.target.value === "" || value <= 0 || isNaN(value)) setContactsPerCharacter(100)
                }}
              ...
              <InputWithLabel
                ...
                onBlur={e => {
                  const value = Number(e.target.value)
                  if (e.target.value === "" || value <= 0 || isNaN(value)) setContactsPerSession(100)
                }}
