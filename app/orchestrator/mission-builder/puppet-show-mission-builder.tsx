...
export function PuppetShowMissionBuilder() {
    ...
    const updateMessage = (id: string, message: MessageWithMedia | null) => {
        setMessages((prev) => prev.map((msg) => (msg.id === id ? { ...msg, message } : msg)))
    }

    const updateStartTime = (id: string, startTime: Date | undefined) => {
        setMessages((prev) => prev.map((msg) => (msg.id === id ? { ...msg, startTime } : msg)))
    }
        ...
        <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-4">
                ...
                <p className="text-sm text-gray-600">
                    Configure the first messages that will be sent to start the puppet show. Each
                    message can have an optional start time.
                </p>
                                    ...
                                    <div>
                                        ...
                                        <MessageBuilder
                                            ...
                                            onUpdateMessages={(messages) =>
                                                updateMessage(messageState.id, messages[0] || null)
                                            }
                                        />
                                    </div>
