...
export function MissionView({ mission, avatars }: { mission: MissionRead; avatars: AvatarModelWithProxy[] }) {
  const [plannedMission, setPlannedMission] = useState<{ mission: MissionRead; scenarios: ScenarioRead[] } | null>(null)
        ...
        <div className="flex flex-col mt-12 px-4">
          <Tabs defaultValue="scenarios" className="w-full">
            ...
            <TabsContent value="statistics" className="mt-4">
              {mission.status_code !== "planned" && <MissionStatistics mission={mission} />}
            </TabsContent>
          </Tabs>
        </div>
      </div>
