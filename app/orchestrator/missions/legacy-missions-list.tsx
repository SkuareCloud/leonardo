...
/**
 * Renders the legacy missions list, which shows all missions, even ones unrelated to exposure.
 */
export function LegacyMissionsList({ missions: initialMissions }: { missions: MissionRead[] }) {
