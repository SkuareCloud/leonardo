...
export function ScenarioForm({ avatars: avatarsProp, initialScenario }: ScenarioFormProps) {
    ...
    const filteredAvatars = useMemo(() => {
        ...
        return avatars.filter((avatar) => {
            ...
            return (
                avatarName.toLowerCase().includes(searchTerm) ||
                avatarId.toLowerCase().includes(searchTerm)
            )
        })
    ...
    const handleChatIdChange = (
        index: number,
        value: string,
        field: "chat" | "from_chat" | "target_chat",
    ) => {
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        {!action.args.chat?.id && !action.args.chat?.name && (
                                            <p className="text-sm text-red-500">
                                                Please provide either Chat ID or Chat Name
                                            </p>
                                        )}
                                    </div>
                                    <div className="flex flex-col gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex gap-4">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                />
                                                <Label htmlFor={`join-method-chat-${index}`}>
                                                    Chat Info
                                                </Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                ...
                                                />
                                                <Label htmlFor={`join-method-invite-${index}`}>
                                                    Invite Link
                                                </Label>
                                            </div>
                                        </div>
                                    ...
                                    {action.args.invite_link === undefined ? (
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <Input
                                                ...
                                                className={
                                                    !action.args.invite_link ? "border-red-500" : ""
                                                }
                                            />
                                            {!action.args.invite_link && (
                                                <p className="text-sm text-red-500">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <input
                                            ...
                                            checked={
                                                action.args.join_discussion_group_if_availble ||
                                                false
                                            }
                                            onChange={(e) =>
                                                updateAction(index, {
                                                    args: {
                                                        ...action.args,
                                                        join_discussion_group_if_availble:
                                                            e.target.checked,
                                                    },
                                                })
                                            }
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex gap-4">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                />
                                                <Label htmlFor={`reply-method-chat-${index}`}>
                                                    Chat Info
                                                </Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                ...
                                                />
                                                <Label htmlFor={`reply-method-link-${index}`}>
                                                    Message Link
                                                </Label>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Input
                                                        value={
                                                            action.args.message_info?.message_id ||
                                                            ""
                                                        }
                                                        onChange={(e) =>
                                                            updateAction(index, {
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Input
                                                        type="text"
                                                        value={
                                                            action.args.message_info?.timestamp ||
                                                            ""
                                                        }
                                                        onChange={(e) =>
                                                            updateAction(index, {
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Input
                                                        value={
                                                            action.args.message_info?.peer_id || ""
                                                        }
                                                        onChange={(e) =>
                                                            updateAction(index, {
                                                                args: {
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Input
                                                        value={
                                                            action.args.message_info?.from_id || ""
                                                        }
                                                        onChange={(e) =>
                                                            updateAction(index, {
                                                                args: {
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Input
                                                        value={
                                                            action.args.message_info?.text_hash ||
                                                            ""
                                                        }
                                                        onChange={(e) =>
                                                            updateAction(index, {
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <Input
                                                        value={
                                                            action.args.message_info?.viewer_id ||
                                                            ""
                                                        }
                                                        onChange={(e) =>
                                                            updateAction(index, {
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex gap-4">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                />
                                                <Label htmlFor={`forward-method-chat-${index}`}>
                                                    Chat Info
                                                </Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                ...
                                                />
                                                <Label htmlFor={`forward-method-link-${index}`}>
                                                    Message Link
                                                </Label>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="grid grid-cols-2 gap-2">
                                                <Input
                                                    ...
                                                    placeholder="Chat ID (number)"
                                                    className={
                                                        !action.args.from_chat?.id &&
                                                        !action.args.from_chat?.name
                                                            ? "border-red-500"
                                                            : ""
                                                    }
                                                />
                                            ...
                                            {!action.args.from_chat?.id &&
                                                !action.args.from_chat?.name && (
                                                    <p className="text-sm text-red-500">
                                                        Please provide either From Chat ID or From
                                                        Chat Name
                                                    </p>
                                                )}
                                        </div>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <Input
                                                ...
                                                placeholder="Chat ID (number)"
                                                className={
                                                    !action.args.target_chat?.id &&
                                                    !action.args.target_chat?.name
                                                        ? "border-red-500"
                                                        : ""
                                                }
                                            />
                                        ...
                                        {!action.args.target_chat?.id &&
                                            !action.args.target_chat?.name && (
                                                <p className="text-sm text-red-500">
                                                    Please provide either Target Chat ID or Target
                                                    Chat Name
                                                </p>
                                            )}
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="mt-2">
                                            <Label>Attachments</Label>
                                            <div className="space-y-2">
                                                {(action.args.message?.attachments || []).map(
                                                    (attachment: Attachment, attIndex: number) => (
                                                        <div
                                                            key={attIndex}
                                                            className="flex items-center gap-2"
                            ...
                            {action.type === "behavioural" && (
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        />
                                        <Label htmlFor={`sync-personal-details-${index}`}>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <input
                                            ...
                                            checked={
                                                action.args.disable_auto_download_media || false
                                            }
                                            onChange={(e) =>
                                                updateAction(index, {
                                                    args: {
                                                        ...action.args,
                                                        disable_auto_download_media:
                                                            e.target.checked,
                                                    },
                                                })
                                            }
                                        />
                                        <Label htmlFor={`disable-auto-download-media-${index}`}>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <input
                                            ...
                                            checked={
                                                action.args.delete_all_active_sessions || false
                                            }
                                            onChange={(e) =>
                                                updateAction(index, {
                                                    args: {
                                        ...
                                        />
                                        <Label htmlFor={`delete-all-active-sessions-${index}`}>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        />
                                        <Label htmlFor={`get-unread-messages-${index}`}>
                                            Get Unread Messages
                                        </Label>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <Input
                                            ...
                                            className={
                                                !action.args.phone_number ? "border-red-500" : ""
                                            }
                                        />
                            ...
                            {action.type === "read_messages" && (
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        />
                                        <Label htmlFor={`read-all-in-end-${index}`}>
