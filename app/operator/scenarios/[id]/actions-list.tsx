...
const ChatInfoDisplay = ({ chat, avatarUrl, subtitle, subtitleImageUrl }: ChatInfoDisplayProps) => {
    ...
    return (
        <div
            className="flex h-12 w-48 items-center gap-2 rounded bg-gray-800 px-2 py-1"
            style={{ minWidth: 0 }}
        >
            {/* Avatar */}
            <div className="h-6 w-6 flex-shrink-0 overflow-hidden rounded-full bg-gray-800">
                {avatar ? (
                    <Image
                        src={avatar}
                        alt={name}
            ...
            <div className="flex min-w-0 flex-col">
                ...
                {chat.members && (
                    <span className="truncate text-xs leading-tight text-gray-200/50">
...
function ActionsList({ scenario }: ActionsListProps) {
                ...
                return (
                    <div className="space-y-2">
                        ...
                        <div className="flex items-end gap-2">
                            <div
                                className="relative max-w-xs rounded-2xl bg-purple-400 px-4 py-2 text-white shadow"
                                style={{
                    ...
                    <div className="space-y-2">
                        {forwardArgs.message_link ? (
                            <div className="flex items-center gap-2">
                                ...
                                <div
                                    className="max-w-xs truncate text-sm text-gray-600"
                                    title={forwardArgs.message_link}
                                >
                                    {forwardArgs.message_link}
                                </div>
                            </div>
                ...
                return (
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-col gap-1">
                            {readArgs.amount_messages !== undefined &&
                                readArgs.amount_messages !== null && (
                                    <div className="text-sm text-gray-600">
                ...
                return (
                    <div className="space-y-2">
                        ...
                        {replyContent.message_info.timestamp && (
                            <div className="text-sm text-gray-600">
                                Replied at:{" "}
                                {formatDate(new Date(replyContent.message_info.timestamp))}
                            </div>
                        )}
                    </div>
                )
                ...
                return (
                    <div className="space-y-2">
                        ...
                        {joinContent.discussion_group_chat_info && (
                            <div>
                                <div className="mb-1 text-sm font-medium">Discussion Group:</div>
                ...
                return (
                    <div className="space-y-2">
                        ...
                        {forwardContent.message_info.timestamp && (
                            <div className="text-sm text-gray-600">
                                Forwarded at:{" "}
                                {formatDate(new Date(forwardContent.message_info.timestamp))}
                            </div>
                        )}
                    </div>
                )
                    ...
                    <div className="space-y-4">
                        ...
                        {behaviouralContent.personal_details_synced !== undefined && (
                            <div className="flex items-center gap-2">
                                <Badge
                                    variant={
                                        Boolean(behaviouralContent.personal_details_synced)
                                            ? "default"
                                            : "secondary"
                                    }
                                >
                        ...
                        {behaviouralContent.auto_download_media_disabled !== undefined && (
                            <div className="flex items-center gap-2">
                                <Badge
                                    variant={
                                        Boolean(behaviouralContent.auto_download_media_disabled)
                                            ? "default"
                                            : "secondary"
                                    }
                                >
                        ...
                        {behaviouralContent.all_active_sessions_deleted !== undefined && (
                            <div className="flex items-center gap-2">
                                <Badge
                                    variant={
                                        Boolean(behaviouralContent.all_active_sessions_deleted)
                                            ? "default"
                                            : "secondary"
                                    }
                                >
                        ...
                        {behaviouralContent.chats && behaviouralContent.chats.length > 0 && (
                            <div>
                                <div className="mb-2 text-sm font-medium">
                                    Available Chats ({behaviouralContent.chats.length}):
                                </div>
                                            ...
                                            <TableBody>
                                                {behaviouralContent.chats.map((chat, idx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell className="max-w-xs py-2 text-xs text-gray-600">
                                                            <div
                                                                className="truncate"
                                                                title={
                                                                    chat.description ||
                        ...
                        {/* Unread Messages */}
                        {behaviouralContent.unread_messages &&
                            behaviouralContent.unread_messages.length > 0 && (
                                <div>
                                    <div className="mb-2 text-sm font-medium">
                                    ...
                                    <div className="rounded-md border">
                                        <div className="max-h-48 overflow-y-auto">
                                            <Table>
                                                ...
                                                <TableBody>
                                                    {behaviouralContent.unread_messages.map(
                                                        (chat, idx) => (
                                                            <TableRow
                                                                key={idx}
                                                                className="hover:bg-gray-50"
                        ...
                        {/* Current Context */}
                        {Boolean(behaviouralContent.current_context) && (
                            <div>
                                <div className="mb-2 text-sm font-medium">Current Context:</div>
                ...
                if (resolveContent.user_info) {
                    ...
                    return (
                        <div className="space-y-1 rounded-md border bg-gray-50 p-3">
                            ...
                            {user.title && (
                                <div className="text-xs text-gray-600">Title: {user.title}</div>
                            )}
                            {user.subtitle && (
    ...
    const actionsData: ActionDataRow[] = scenario.scenario.actions.map(
        (action: any, index: number) => {
            const actionResponse = scenario.result?.actions_responses?.[index]
            const startTime = actionResponse?.start_time
                ? new Date(actionResponse.start_time)
                : null
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="max-w-xs">
                        {formatActionArgs(action.actionType, action.actionArgs)}
                    </div>
                )
            },
        },
                        ...
                        <Tooltip delayDuration={200}>
                            <TooltipTrigger asChild>
                                <div className="flex items-center gap-1">
                                    ...
                                    {action.error_code && (
                                        <Badge className={getErrorCodeColor(action.error_code)}>
                                            {action.error_code}
                                        </Badge>
                                    )}
                                </div>
                            ...
                            <TooltipContent
                                side="top"
                                sideOffset={10}
                                className="z-20 max-w-[300px] rounded-lg border border-red-100 bg-white/95 px-4 py-3 shadow-lg backdrop-blur-sm"
                            >
                                {action.error && (
                                    <div className="text-xs font-medium break-words whitespace-pre-wrap text-red-600">
                                        {action.error}
                                    </div>
                                )}
                            </TooltipContent>
                ...
                return (
                    <div className="space-y-2 text-xs">
                        {action.startTime && (
                            <div className="flex items-center gap-1 text-gray-700">
                                ...
                                <span className="text-gray-600">
                                    {formatDate(action.startTime, true)}
                                </span>
                            </div>
                        )}
                        {action.endTime && (
                            <div className="flex items-center gap-1 text-gray-700">
                                ...
                                <span className="text-gray-600">
                                    {formatDate(action.endTime, true)}
                                </span>
                            </div>
                        )}
                        ...
                        {!action.startTime && !action.endTime && (
                            <div className="text-gray-400 italic">No timing data</div>
                        )}
                    </div>
                )
            },
                ...
                return (
                    <div className="max-w-xs">
                        {action.responseContent &&
                            formatResponseContent(action.actionType, action.responseContent)}
                    </div>
                )
            },
        },
